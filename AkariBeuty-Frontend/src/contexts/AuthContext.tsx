...
interface AuthContextType {
    ...
    login: (
        email: string,
        password: string,
        options?: { type?: "cliente" | "profissional" | "empresa" | "usuario" }
    ) => Promise<boolean>;
    logout: () => void;
...
export const AuthProvider: React.FC<Props> = ({ children }) => {
    ...
    async function login(
        ...
        try {
            ...
            type TokenResponse = { token?: string; data?: unknown } | string | null | undefined;
            const extractToken = (payload: TokenResponse): string | undefined => {
            ...
            if (targetType === "cliente") {
                ...
                const response = await service.request<TokenResponse>();

        ...
        >
          ...
          {loginSingup === "login" ? (
            <div className="flex flex-row items-center justify-center space-x-4 w-full">
              <div>
                <Button
                  label="SINGUP EMPRESA"
                  icon={<SignIn size={28} weight="bold" className="mr-[10px]" />}
                  background="bg-primary"
                  color="text-textSecondary"
                  size="text-2xl"
                  action={() => alterLoginSingup("empresa")}
                />
              </div>

              <div>
                <Button
                  label="SINGUP USUÁRIO"
                  icon={<SignIn size={28} weight="bold" className="mr-[10px]" />}
                  background="bg-primary"
                  color="text-textSecondary"
                  size="text-2xl"
                  action={() => alterLoginSingup("cliente")}
                />
              </div>
            </div>
          ) : (
